...
var
    CUV = new Subject([], "CUV", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"),                             						
    GAN = new Subject([], "GAN", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"),            						
    ICD = new Subject([], "ICD", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"),  	
    IAC = new Subject([], "IAC", "https://emap.fgv.br/disciplina/graduacao/introducao-computacao"),        					
    ADV = new Subject([], "ADV", "https://emap.fgv.br/disciplina/graduacao-ciencia-de-dados/analise-exploratoria-de-dados-visualizacao"),
    CVV = new Subject([CUV], "CVV", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"),                  						
    ALL = new Subject([GAN], "ALL", "https://emap.fgv.br/disciplina/graduacao/algebra-linear"),              						
    IAE = new Subject([], "IAE", "https://emap.fgv.br/disciplina/graduacao/introducao-economia"),               				
    LDP = new Subject([IAC], "LDP", "https://emap.fgv.br/disciplina/graduacao/linguagens-de-programacao"), 					
    BDD = new Subject([IAC], "BDD", "https://emap.fgv.br/disciplina/graduacao-ciencia-de-dados/analise-exploratoria-de-dados-visualizacao"),
	EDO = new Subject([CVV, ALL], "EDO", "https://emap.fgv.br/disciplina/graduacao/equacoes-diferenciais-ordinarias-edo"), 						
    TDP = new Subject([ALL, CVV], "TDP", "https://emap.fgv.br/disciplina/graduacao/teoria-probabilidade"),   						
    ALN = new Subject([LDP, ALL], "ALN", "https://emap.fgv.br/disciplina/graduacao/algebra-linear-numerica"),   				
    EDA = new Subject([LDP], "EDA", "https://emap.fgv.br/disciplina/graduacao/estruturas-de-dados-algoritmos"),     		
    TAC = new Subject([ICD, ADV, LDP], "TAC", "https://emap.fgv.br/disciplina/graduacao-ciencia-de-dados/tecnicas-algoritmos-ciencia-de-dados"),
	OCD = new Subject([ALL, TDP, CVV], "OCD", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"),    
    IES = new Subject([TDP], "IES", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"),      						
    MMD = new Subject([], "MMD", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"),     						
    MGI = new Subject([BDD], "MGI", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"), 	
    PLN = new Subject([EDA], "PLN", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"),
	IAR = new Subject([CUV], "IAR", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"),            			
    MES = new Subject([IES], "MES", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"),       						
    ADM = new Subject([OCD, IES], "ADM", "https://emap.fgv.br/disciplina/graduacao-ciencia-de-dados/aprendizado-de-maquinas"),  
    CES = new Subject([BDD, TAC], "CES", "https://emap.fgv.br/disciplina/graduacao-ciencia-de-dados/computacao-escalavel"), 
	CDR = new Subject([TDP, EDA, MMD], "CDR", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"),        			
    STP = new Subject([MES], "STP", "https://emap.fgv.br/disciplina/graduacao-ciencia-de-dados/series-temporais"),      			
    APP = new Subject([ADM], "APP", "https://emap.fgv.br/disciplina/graduacao-ciencia-de-dados/aprendizado-profundo"),
	PCD = new Subject([TAC, APP], "PCD", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"), 				
    MDC = new Subject([], "MDC", "https://emap.fgv.br/disciplina/graduacao-ciencia-de-dados/metodologia-cientifica"), 				
    EC1 = new Subject([], "EC1", "https://emap.fgv.br/disciplina/graduacao-ciencia-de-dados/estagio-curricular-obrigatorio-i"),
	EMD = new Subject([], "EMD", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"),        				
    TCC = new Subject([MDC], "TCC", "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"),    
    EC2 = new Subject([], "EC2",    "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular"),
    LBR = new Subject([], "LBR",     "https://utec.edu.pe/carreras/ciencia-de-datos/malla-curricular");
